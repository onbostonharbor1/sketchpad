...
window.drawRegistry_lissajous = {
  ...
  controls: {
    ...
    chordLength:{ widget: "range", min: 10,  max: 80,  step: 1,  label: "Chord Length:" },
    numNodes:   { widget: "range", min: 50,  max: 400, step: 5,  label: "# Nodes:" },
    startSkip:  { widget: "range", min: -50, max: 50,  step: 1,  label: "Start Skip:" },
    endSkip:    { widget: "range", min: -50, max: 50,  step: 1,  label: "End Skip:" },
      withinCirc: {
	  widget: "select",
	  options: [
