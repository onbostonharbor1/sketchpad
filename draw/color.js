export function calculateTintAndShade(color, percentage) {
    ...
    if (typeof color !== "string") {
        throw new Error("calculateTintAndShade: color must be a string");
    }

    if (color.startsWith("#")) {
        hexColor = color;
    } else {
        hexColor = colourNameToHex(color);
        if (!hexColor) {
            throw new Error("calculateTintAndShade: unknown color name: " + color);
        }
    }
    ...
    // ------------------------------------------------------------
    // Shade calculation (toward black)
    // ------------------------------------------------------------
    ...
    return {
        tint: {
            ...
            g: tintG,
            b: tintB,
            hex: rgbToHex(tintR, tintG, tintB)
        },
        shade: {
            r: shadeR,
            g: shadeG,
            b: shadeB,
            hex: rgbToHex(shadeR, shadeG, shadeB)
        }
    };
