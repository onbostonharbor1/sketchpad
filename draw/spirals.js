...
//////////////////////////////////////////////////////////////////
export function drawEulerSpiral(thing, totalLength, numSegments, scaleFactor) {
	let x = 0;
	let y = 0;
	let t = 0;
...
// drawFermatSpiral
//////////////////////////////////////////////////////////////////
export function drawFermatSpiral(thing, scaleFactor, numTurns, gap) {
...
//////////////////////////////////////////////////////////////////
export function drawLogarithmicSpiral(thing, a, b, startAngle, endAngle, step) {
    ctx.strokeStyle = thing.color;
    ctx.lineWidth   = thing.lineWidth;
    ctx.beginPath();
    let firstPoint = true;

    foror (let theta = startAngle; theta <= endAngle; theta += step) {
...
// drawPureSpiral
//////////////////////////////////////////////////////////////////
export function drawPureSpiral(thing, angle,spread,maxAngle) {
	ctx.strokeStyle = thing.color;
	ctx.lineWidth   = thing.lineWidth;
//	let counter = 0;
...
// drawPureSpiralA
//////////////////////////////////////////////////////////////////
export function drawPureSpiralA(thing,gap,numRotations) {
	ctx.strokeStyle = thing.color;
	ctx.lineWidth   = thing.lineWidth;
    ctx.moveTo(thing.midpoint.x, thing.midpoint.y);

//  let gap = 1.8;                // increase this for spacing between spiral lines
...
// drawPureSpiralB
//////////////////////////////////////////////////////////////////
export function drawPureSpiralB(thing,ptsToDraw) {
	ctx.strokeStyle = thing.color;
	ctx.lineWidth   = thing.lineWidth;
	ctx.fillStyle   = "green";
...
// drawTheodorusSpiral
//////////////////////////////////////////////////////////////////
export function drawTheodorusSpiral(thing, numTriangles) {
