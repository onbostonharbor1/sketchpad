...
function drawLissajous(thing) {
  ...
  window.ctx.strokeStyle = thing.color;
  ...
  for (let i = 0; i <= thing.steps; i++) {
    ...
    if (i === 0) window.ctx.moveTo(x, y);
    else window.ctx.lineTo(x, y);
...
export const scriptInfo = {
  ...
  controls: {
    ...
    steps:     { label: "Steps",      widget: "range", min: 500, max: 12000, step: 100, default: 5000 },
